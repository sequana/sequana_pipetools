...
class Options(argparse.ArgumentParser):
    def __init__(self, prog="sequana_start_pipeline"):
        ...
        self.add_argument("--keywords", dest="keywords", default=None, help="Keywords (you can edit later)")
        self.add_argument(
            "--description",
            dest="description",
            default=None,
        ...
        self.add_argument("--output-directory", default=".", help="where to save the final directory")
...
def main(args=None):
    ...
    cookiecutter(
        "https://github.com/sequana/sequana_pipeline_template",
